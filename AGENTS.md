...
- Blueprint Workspace 右上 Actions 区在“新建蓝图”左侧提供“创意工坊”入口；该入口进入 Fullscreen Global Space，不把发布管理塞进 Workspace。Web Prototype 由 GameplayScreen 持有这个全屏 Blocking Space，以保留 reducer / 玩家蓝图 / Blueprint ViewState；打开期间普通 Gameplay UI 不渲染。Workshop Content 可以包含多个“我的蓝图”；浏览别人内容仍由 Blueprint 来源筛选负责。发布管理按 Draft / Published Snapshot / Provider 分层，Web 不冒充真实 Steamworks。
