...
- 普通主游玩采用底部三岛：左下 World Dock 放相机 / 环境 / 地图解锁 / 区域 / 地形 / 配色，中下 Main Dock 只管建设分类，右下 Utility 保持单行网格 / 范围动作 / Undo / Redo / 批量摧毁。Camera / Weather 从顶部 Control Tray 移除；Workspace / Tool / Building Selection 隐藏左下 World Dock。
