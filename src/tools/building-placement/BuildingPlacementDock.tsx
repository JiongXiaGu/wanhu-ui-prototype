      ...
      items: [
        {
          ...
          label: '平衡挖填',
          icon: Mountain,
          active: state.buildingTerrainMode === 'balanced-earthwork',
          onClick: () => dispatch({ type: 'SET_BUILDING_TERRAIN_MODE', mode: 'balanced-earthwork' }),
        },
        {
          id: 'fill-only',
          label: '只填不挖',
          icon: ArrowUp,
          active: state.buildingTerrainMode === 'fill-only',
          onClick: () => dispatch({ type: 'SET_BUILDING_TERRAIN_MODE', mode: 'fill-only' }),
        },
        {
          id: 'manual-elevation',
          label: '手动标高',
          icon: Ruler,
          active: state.buildingTerrainMode === 'manual-elevation',
          onClick: () => dispatch({ type: 'SET_BUILDING_TERRAIN_MODE', mode: 'manual-elevation' }),
        },
      ],
    },
    {
