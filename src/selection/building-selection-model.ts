...
export interface BuildingSelectionAppearance { schemeId: string; weathering: number; }
export interface BuildingSelectionDefinition {
  id: string;
  name: string;
  category: string;
  district: string;
  ...
  appearance: BuildingSelectionAppearance;
  sections: readonly BuildingSelectionSection[];
}
export const BUILDING_SELECTIONS: readonly BuildingSelectionDefinition[] = [
  {
    id:'building-riverside-inn',name:'临河食肆',category:'商业',district:'南岸市坊',status:'正常营业',
    anchor:{left:1460,top:520,width:190,height:138},
    appearance:{schemeId:'ink-restrained',weathering:0.48},
    sections:[
  ...
  {
    id:'building-yongan-residence',name:'永安坊民居',category:'民居',district:'西坊',status:'居住稳定',
    anchor:{left:570,top:650,width:220,height:138},
    appearance:{schemeId:'white-wall',weathering:0.58},
    sections:[
  ...
  {
    id:'building-waterfront-workshop',name:'河埠木作坊',category:'工坊',district:'东河埠',status:'生产中',
    anchor:{left:1090,top:690,width:205,height:128},
    appearance:{schemeId:'mountain-natural',weathering:0.35},
    sections:[
