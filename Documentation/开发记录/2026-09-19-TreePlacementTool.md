# 2026-09-19 Tree Placement Tool
...
- 使用 ToolOrigin 返回树木 Workspace；
- 新增 Review Scenario 与 Playwright Visual Review；
- Tree Variant 不包含 Season / Growth / LOD；真实 Brush / Selection / Gizmo 由正式 Unity World Tool 实现。
